...
"------------------------------------------------------------------------------
" LSP Tutorial https://odysee.com/@teej_dv:d/the-only-video-you-need-to-get-started:b
" location: /opt/local/share/nvim/runtime/compiler
" colorscheme delek
...
" Notes
"
" :help expand() - expand wildcards (% current file, etc) for use with commands 
" :CocCommand workspace.showOutput Pyright - can get python path being used
